...
class M_acc_pembimbing  extends CI_Model
{
    ...
    var $column_order = array('nim', 'nama', 'email', 'hp', 'judul_skripsi','tgl_daftar_sempro', 'status_sempro');
    var $column_search = array('nim', 'nama', 'email', 'hp', 'judul_skripsi','tgl_daftar_sempro', 'status_sempro');
