...
<body class="nav-md">
  <div class="container body">
    <div class="main_container">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-check"></i>ACC Pembimbing</a></li>
                <li><a href="<?= base_url('index.php/Main/index1') ?>"><i class="fa fa-users"></i>Set Penguji</a></li>
                <li><a><i class="fa fa-calendar"></i>Jadwal Ujian</a></li>
                <li><a href="<?= base_url('index.php/Main/index2') ?>"><i class="fa fa-book"></i>Hasil Ujian</a></li>
      ...
      <br/>
      <a href="<?= base_url('index.php/Main/index3') ?>"><input style="border-radius: 4px; border: none; height: 23px; color: white; background: #2A3F54;" 
