...
class M_setpenguji extends CI_Model
{
    ...
    var $column_order = array('nim', 'nama', 'email', 'hp', 'judul_skripsi', 'status','penguji1','penguji2','penguji3');
    var $column_search = array('nim', 'nama', 'email', 'hp', 'judul_skripsi', 'status','penguji1','penguji2','penguji3');
